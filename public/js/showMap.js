 ...
 */
 ...
 ;(function( $ ){
 	...
 	var getData = function(){
 		...
 		gStartPosition = new google.maps.LatLng( getLatLng( $('#showMap').attr('data-location'),'lat'), getLatLng($('#showMap').attr('data-location'),'lng') );
 	...
 	var displayGoogleMap = function(){
 		...
 		gMap = new google.maps.Map(document.getElementById('showMap'),{
