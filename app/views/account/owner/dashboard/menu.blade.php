<div class="menu-agence account-submenu">
    <ul>
        ...
        <li>
            <a class="tooltip-ui-s" title="{{trans('dashboard.title_edit')}}" href="{{route('index_inscription_adverts',array(Auth::user()->slug, $location->building->id))}}">{{trans('general.edit')}}</a>
        </li>
