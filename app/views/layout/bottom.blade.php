...
<script>
   $(function() {
   $('.tooltip-ui-e').tipsy({ fade: true, gravity:'w', delayOut: 300, opacity: 0.9});
   $('.tooltip-ui-w').tipsy({ fade: true, gravity:'e', delayOut: 300, opacity: 0.9});
   $('.tooltip-ui-s').tipsy({ fade: true, gravity:'n', delayOut: 300, opacity: 0.9});
   $('.tooltip-ui-n').tipsy({ fade: true, gravity:'s', delayOut: 300, opacity: 0.9});
 });
</script>
